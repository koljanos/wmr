...
#define WMR_UTIL_C_TXT_2 "- WMR (разделяемая память), ошибка инициализации, процесс: %d мастер ключ: %d ид: %d\n"
...
#define WMR_UTIL_C_TXT_6 "- WMR (разделяемая память), ошибка инициализации - процесс: %d ключ используемый потомком: %d ид: %d\n\n"
